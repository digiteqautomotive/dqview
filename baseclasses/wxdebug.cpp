...
void WINAPI DbgBreakPoint(LPCTSTR pFileName,INT iLine,LPCTSTR szFormatString,...)
{
...
//
void WINAPI DbgLogInfo(DWORD Type,DWORD Level,LPCSTR pFormat,...)
{
...
CDisp::CDisp(IPin *pPin) {Init(pPin);}
