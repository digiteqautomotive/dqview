...
public:
	...
	inline BOOL ReadOnly() { return m_bReadOnly ; }
...
public:
	...
	CTransInPlaceFilter(LPCTSTR, LPUNKNOWN, REFCLSID clsid, HRESULT *,
                        bool bModifiesData = true);
#ifdef UNICODE
	CTransInPlaceFilter(LPCSTR, LPUNKNOWN, REFCLSID clsid, HRESULT *,
                        bool bModifiesData = true);
#endif
