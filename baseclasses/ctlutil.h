...
public:
	...
	virtual HRESULT GetMediaTime(LONGLONG *, LONGLONG *) {
        return E_FAIL;
    }
...
class CBasicAudio : public IBasicAudio, public CUnknown
{
    CBaseDispatch m_basedisp;

public:

	CBasicAudio(LPCTSTR, LPUNKNOWN);
...
class CBaseBasicVideo : public IBasicVideo2, public CUnknown
{
    CBaseDispatch m_basedisp;

public:

	CBaseBasicVideo(LPCTSTR, LPUNKNOWN);
	...
	STDMETHODIMP GetPreferredAspectRatio(long *, long *)
    {
        return E_NOTIMPL;
    }
};
...
class CBaseVideoWindow : public IVideoWindow, public CUnknown
{
    CBaseDispatch m_basedisp;

public:

	CBaseVideoWindow(LPCTSTR, LPUNKNOWN);
...
class CSourcePosition : public CMediaPosition
{

public:
	CSourcePosition(LPCTSTR, LPUNKNOWN, HRESULT*, CCritSec *);
	...
	STDMETHODIMP get_CurrentPosition(REFTIME *) {
        return E_NOTIMPL;
	}
...
protected:
    ...
    // ctor
	CSourceSeeking(LPCTSTR, LPUNKNOWN, HRESULT*, CCritSec *);
