...
CBaseMediaFilter::CBaseMediaFilter(LPCTSTR pName,
				   LPUNKNOWN    pUnk,
				   CCritSec *pLock,
				   REFCLSID clsid) :
    CUnknown(pName, pUnk),
...
CBaseFilter::CBaseFilter(LPCTSTR pName,
			 LPUNKNOWN  pUnk,
			 CCritSec   *pLock,
			 REFCLSID   clsid) :
    CUnknown( pName, pUnk ),
...
#ifdef UNICODE
CBaseFilter::CBaseFilter(LPCSTR pName,
			 LPUNKNOWN  pUnk,
			 CCritSec   *pLock,
			 REFCLSID   clsid) :
    CUnknown( pName, pUnk ),
...
// by their pin names
STDMETHODIMP
CBaseFilter::FindPin(LPCWSTR Id, IPin ** ppPin)
{
...
CBasePin::CBasePin(LPCTSTR pObjectName,
		   CBaseFilter *pFilter,
		   CCritSec *pLock,
		   HRESULT *phr,
		   LPCWSTR pName,
...
#ifdef UNICODE
CBasePin::CBasePin(LPCSTR pObjectName,
		   CBaseFilter *pFilter,
		   CCritSec *pLock,
		   HRESULT *phr,
		   LPCWSTR pName,
...
CBaseOutputPin::CBaseOutputPin(LPCTSTR pObjectName,
				   CBaseFilter *pFilter,
				   CCritSec *pLock,
				   HRESULT *phr,
				   LPCWSTR pName) :
...
#ifdef UNICODE
CBaseOutputPin::CBaseOutputPin(LPCSTR pObjectName,
				   CBaseFilter *pFilter,
				   CCritSec *pLock,
				   HRESULT *phr,
				   LPCWSTR pName) :
...
CBaseInputPin::CBaseInputPin(LPCTSTR pObjectName,
				 CBaseFilter *pFilter,
				 CCritSec *pLock,
				 HRESULT *phr,
				 LPCWSTR pPinName) :
...
#ifdef UNICODE
CBaseInputPin::CBaseInputPin(LPCSTR pObjectName,
				 CBaseFilter *pFilter,
				 CCritSec *pLock,
				 HRESULT *phr,
				 LPCWSTR pPinName) :
...
CMediaSample::CMediaSample(LPCTSTR pName,
...
#ifdef UNICODE
CMediaSample::CMediaSample(LPCSTR pName,
			   CBaseAllocator *pAllocator,
			   HRESULT *phr,
			   LPBYTE pBuffer,
               LONG length) :
...
CBaseAllocator::CBaseAllocator(LPCTSTR pName,
                               LPUNKNOWN pUnk,
                               HRESULT *phr,
                               BOOL bEvent,
...
#ifdef UNICODE
CBaseAllocator::CBaseAllocator(LPCSTR pName,
                               LPUNKNOWN pUnk,
                               HRESULT *phr,
                               BOOL bEvent,
                               BOOL fEnableReleaseCallback) :
